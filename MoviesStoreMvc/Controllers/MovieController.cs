...
namespace MoviesStoreMvc.Controllers
{
   // [Authorize(Roles ="Admin")]
    public class MovieController : Controller
    {
        ...
        {
            var model = new Movie();
            model.GenreList = _genreService.List().Select(a => new SelectListItem
            {
                Text = a.GenreName,
                Value = a.Id.ToString()
            });
        ...
        public IActionResult Edit(int id)
        {
            ...
            MultiSelectList multiGenreList = 
                new MultiSelectList(_genreService.List(), "Id","GenreName",selectedGenres);
